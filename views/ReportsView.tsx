                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="text-right">
                                ...
                                <div className="font-semibold text-gray-900">{doors.length} Doors • {hardwareSets.length} Sets</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-[1920px] mx-auto px-8 py-8">
                {currentView === 'selector' && (
                    <div className="space-y-8">
                        ...
                        <div className="text-center max-w-3xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-3">Select Report Type</h2>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                            {/* Door Schedule Card */}
                            <div
                                className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-blue-500 cursor-pointer group"
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <div className="flex items-start justify-between mb-6">
                                        ...
                                        <div className="px-4 py-1.5 bg-blue-50 text-blue-700 text-sm font-semibold rounded-full">
                                            {doors.length} doors
                                        </div>
                                    </div>

                                    {/* Card Title */}
                                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Door Schedule Report</h3>
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-blue-100 px-8 py-6 border-t border-blue-200">
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="font-medium text-blue-900">Live Preview Available</span>
                            ...
                            {/* Hardware Set Card */}
                            <div
                                className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-purple-500 cursor-pointer group"
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    {/* Card Title */}
                                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Hardware Set Report</h3>
                                    <p className="text-gray-600 mb-6 leading-relaxed">
                            ...
                            <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-indigo-500 cursor-pointer group relative"
                                ...
                                <div className="p-8 relative z-10">
                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                                        <div className="flex-1">
                                            ...
                                            <h3 className="text-2xl font-bold text-gray-900 mb-3">Submittal Package & Frame Reports</h3>
                                            ...
                                            <div className="flex flex-wrap gap-3 mb-6">
                                                {['Door Schedule', 'Hardware Sets', 'Elevations', 'Frame Details', 'Cut Sheets'].map((tag) => (
                                                    <span key={tag} className="flex items-center text-sm font-medium text-gray-700 bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-200">
                        ...
                        <div className="max-w-6xl mx-auto mt-12">
                            <div className="bg-white rounded-xl shadow-md p-8">
                                <div className="flex items-center justify-between mb-6">
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900">Recent Exports</h3>
                                        <p className="text-sm text-gray-600 mt-1">Quick access to your previously generated reports</p>
                                    </div>
                ...
                {currentView === 'submittal-package' && (
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <div className="bg-white rounded-xl shadow-lg border-2 border-indigo-500 overflow-hidden flex flex-col h-[calc(100vh-8rem)]">
