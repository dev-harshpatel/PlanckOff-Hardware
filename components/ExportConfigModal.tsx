                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-blue-100 mt-1">Customize your multi-sheet Excel export</p>
                        </div>
                        <button
                            onClick={onClose}
                ...
                <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 220px)' }}>
                    {currentTab === 'sheets' && (
                        <div className="space-y-4">
                            <p className="text-gray-600 mb-4">Select which sheets to include in your export</p>

                            {/* Door Schedule */}
                            <div className={`flex items-start gap-3 p-4 border-2 rounded-lg transition-colors ${config.sheets.doorSchedule ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                                }`}>
                                <input
                                    type="checkbox"
                                ...
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-900">Door Schedule</h4>
                            ...
                            {/* Hardware Schedule */}
                            <div className={`flex items-start gap-3 p-4 border-2 rounded-lg transition-colors ${config.sheets.hardwareSchedule ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                                }`}>
                                <input
                                    type="checkbox"
                                ...
                                />
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-900">Hardware Schedule</h4>
                                    <p className="text-sm text-gray-600 mt-1">
                            ...
                            {/* Frame Details */}
                            <div className={`flex items-start gap-3 p-4 border-2 rounded-lg transition-colors ${config.sheets.frameDetails ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                                }`}>
                                <input
                                    type="checkbox"
                                ...
                                />
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-900">Frame Details</h4>
                                    <p className="text-sm text-gray-600 mt-1">
                            ...
                            {/* Procurement Summary */}
                            <div className={`flex items-start gap-3 p-4 border-2 rounded-lg transition-colors ${config.sheets.procurementSummary ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                                }`}>
                                <input
                                    type="checkbox"
                                ...
                                />
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-900">Procurement Summary</h4>
                                    <p className="text-sm text-gray-600 mt-1">
                    ...
                    {currentTab === 'columns' && (
                        <div>
                            <p className="text-gray-600 mb-4">Column customization coming soon</p>
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-blue-900">Feature Coming Soon</h4>
                    ...
                    {currentTab === 'presets' && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h4 className="font-bold text-gray-900 mb-3">Save Current Configuration</h4>
                            ...
                            {/* Preset List */}
                            <div>
                                <h4 className="font-bold text-gray-900 mb-3">Available Presets</h4>
