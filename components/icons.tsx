...
// This file centralizes all application icons for consistency and easy management.
...
export const TableCellsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h.008v.015h-.008v-.015Zm17.25 0h.008v.015h-.008v-.015Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 4.5h17.25m-17.25 0a1.125 1.125 0 0 0-1.125 1.125v1.5c0 .621.504 1.125 1.125-1.125h17.25c.621 0 1.125-.504 1.125-1.125v-1.5A1.125 1.125 0 0 0 20.625 4.5m-17.25 0h.008v.015h-.008V4.5Zm17.25 0h.008v.015h-.008V4.5Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 0a1.125 1.125 0 0 1-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h16.5c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h.008v.015h-.008v-.015Zm16.5 0h.008v.015h-.008v-.015Z" />
  </svg>
);
